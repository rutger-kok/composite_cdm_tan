...
C Loop through the gauss points
    ...
    !    WRITE(*,110) '11=', trialStrain(1)
    !    WRITE(*,110) '22=', trialStrain(2)
    !    WRITE(*,110) '33=', trialStrain(3)
    !    WRITE(*,110) '12=', trialStrain(4)
    !    WRITE(*,110) '23=', trialStrain(5)
    !    WRITE(*,110) '13=', trialStrain(6)

    !    WRITE(*,110) '11=', trialStress(1)
    !    WRITE(*,110) '22=', trialStress(2)
    !    WRITE(*,110) '33=', trialStress(3)
    !    WRITE(*,110) '12=', trialStress(4)
    !    WRITE(*,110) '23=', trialStress(5)
    !    WRITE(*,110) '13=', trialStress(6)
     ...
     1                    FI_MT,FI_MC)
        ...
        WRITE(*,110) 'FI_LT=', FI_LT
        WRITE(*,110) 'FI_LC=', FI_LC
        WRITE(*,110) 'FI_MT=', FI_MT
        WRITE(*,110) 'FI_MC=', FI_MC
