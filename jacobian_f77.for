     ...
     1                       E22,eTotal_cr) result(A)
        ...
        real*16 :: part1, part2, part3, part4, part5, part41, part42
        real*16 :: part43, part44
        ! output variables
     ...
     3    sign(1.0d0,ec_cr(2)*lch)**2.0d0)
        !print *, term2
        part1 = (0.25d0*ec_cr(2)*lch**2.0d0*(sign(1.0d0,ec_cr(2)*
     ...
     7    sign(1.0d0,tbar_cr(2))**2.0d0)**(1.0d0/2.0d0))
        !print *, 'part1=', part1
        part2 = (sign(1.0d0,ec_cr(2)*lch)*sign(1.0d0,tbar_cr(1))*
     9    sign(1.0d0,tbar_cr(2))*sign(1.0d0,tbar_cr(3))*term1*
     1    term2**0.5d0)
        !print *, 'part2=', part2
        part41 = ec_cr(4)**2.0d0*eta*tbar_cr(2)*(ec_cr(2)*
     ...
     7    ec_cr(4)**2.0d0 + ec_cr(2)**2.0d0)**(0.5d0*eta - 1.5d0)
        !print *, 'part41=', part41
        part42 = (GIIc - GIc)*(tbar_cr(1)**2.0d0*
     ...
     2    ec_cr(4)**2.0d0 + ec_cr(2)**2.0d0)**(1.0d0/2.0d0)
        !print *, 'part43=', part43
        part44 = ec_cr(2)**2.0d0*tbar_cr(2)**2.0d0*(tbar_cr(1)**2.0d0 +
     4    tbar_cr(2)**2.0d0)**(1.0d0/2.0d0)*(4.0d0*
     ...
     8    ec_cr(4)**2.0d0*ec_cr(2)*tbar_cr(1)**2.0d0*tbar_cr(2)
        !print *, 'part44=', part44
        part4 = (part41*part42*term2**(1.0d0/2.0d0)*(part43 - part44))
        !print *, 'part4=', part4
        part5 = (sign(1.0d0,tbar_cr(1))*sign(1.0d0,tbar_cr(2))*
