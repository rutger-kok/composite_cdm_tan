...
for stress1 in np.linspace(-1200.1, 2323.5, n):
    for stress2 in np.linspace(0,161, n):
        # define loading
        trialStress = np.array([stress1, 0.0, 0.0, stress2, 0.0, 0.0])
        ...
        if maxFailCriteria < 0.99: continue
        elif maxFailCriteria >= 0.99 and maxFailCriteria < 1.001: 
