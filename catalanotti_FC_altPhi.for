...
C Write only -
     *     stressNew, stateNew, enerInternNew, enerInelasNew )
     ...
     3     enerInternNew(nblock), enerInelasNew(nblock)
      ...
      CHARACTER*80 cmname
    !   OPEN(1, file = 
    !  1 'C:\Workspace\check\test\FI_data_3.txt',
    !  2 status = 'unknown')
...
C Loop through the gauss points
     ...
     1                    FI_LT,FI_LC)
            ! FI_LC = -1.0d0*trialStrain(1)/(XC/e11)
...
! 100     FORMAT (E,A,E,A,E,A,E,A,E,A,E,A,E,A,E,A,E,A,E,A,E,A,E,A,E,A,E,
!      1          A,E,A,E,A,E,A,E)
...
!      6  trialStrain(6), ',', xOmega1, ',', xOmega2, ',', xOmega3, ',',
!      7  xOmega4, ',', xOmega5, ',', xOmega6
