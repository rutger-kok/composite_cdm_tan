...
! User subroutine VUMAT
    ...
    !  1       action='readwrite',position='append')
      ...
      delta = e22**2.0d0*nu12**2.0d0 + 2*e33*e22*nu12*nu13*nu23 +
     1        e33*e22*nu13**2.0d0 - e11*e22 + e11*e33*nu23**2.0d0
      ...
      IF (stepTime.eq.0) THEN
        ...
        DO k = 1, nblock
          ...
          trialStress = matmul(C,trialStrain)
...
!----------------------------------------------------------------------!
     ...
     1           (e22*nu12 + e33*nu13*nu23 - e33*xOmega3*nu13*nu23)*delta
     ...
     1           (e11*nu23 + e22*nu12*nu13 - e22*xOmega1*nu12*nu13)*delta
...
!----------------------------------------------------------------------!
     ...
     1                    FI_MT,FI_MC)
        ...
        DO p = 1,j
            b(p) = a(p)*(pi/((j-1))) ! create angles from 0 to pi
        END DO
