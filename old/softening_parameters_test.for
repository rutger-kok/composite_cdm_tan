...
C User subroutine VUMAT
      ...
      PARAMETER (eps=1.d-8)
      OPEN(1, file = 
     1 'C:\Workspace\catalanotti_failure_criteria\fail_env_data4.txt',
     2 status = 'unknown')
...
100   FORMAT (E,A,E,A,E,A,E,A,E,A,E,A,E,A,E,A,E,A,E,A,E,A,E)
      ...
      DO k1 = 0, 1000
        DO k2 = 0, 1000
          trialStress(1) = -1.2001 + k1*(0.0070472/2.0)
          trialStress(2) = k2*(0.1602/1000)
          trialStress(3) = 0.0
          trialStress(4) = 0.0 !k2*(0.1302/500)
          trialStress(5) = 0.0
          trialStress(6) = 0.0
          ...
          ELSEIF (trialStress(1).lt.0.d0) THEN
            call ROTATE_PHI(trialStress,phiC,XC,g12,trialStressP,theta,
     1                      phi)
